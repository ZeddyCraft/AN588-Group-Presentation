...
```{r}
# Load the dataset
cleaned_data <- curl("https://github.com/ZeddyCraft/AN588-Group-Presentation/blob/main/Cleaned_Data_4%3A23.csv")
...
Learn to use survey data to test theoretical relationships using linear models.*

### 🧠 Conceptual Focus:   
In anthropology, forming and testing hypotheses helps us connect individual experiences to larger social patterns. For example, we might ask:
"*Does a student’s academic confidence influence how secure they feel about their job prospects?*"
...
Regression helps test relationships between variables — in this case, identifying whether emotional or academic factors are more influential on students' views of their future. 
